...
/** 
 * Class represents the mainview, when the game is running after the player have entered their names
 * @author Besfort Dauti, Nico Janner
 * @version 1.0
*/
public class MainView extends JFrame {
	...
	public MainView(Player player1, Player player2, Player player3, Player player4, ArrayList<Card> stack) {
		...
		JScrollPane scroll = new JScrollPane(gameTxtArea, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
